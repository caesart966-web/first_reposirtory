...
// под текстом там движущаяся карта, и статический расчёт по цвету фона дал бы
// неверный ответ в обе стороны — он увидел бы только тёмно-синий цвет секции
// и не заметил ни кадра, ни пелены поверх него.
