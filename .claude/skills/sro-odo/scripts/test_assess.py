...
CASES = [
    ...
    ("прямой договор с застройщиком", card(contract__procurement="direct"), "yes", "conditional", "build"),
    ...
    ("капремонт 8 млн", card(contract__price_rub=8_000_000.0, work_type="capital_repair"), "no", "conditional", "build"),
    ...
    ("снос 900 тыс.", card(contract__kind="demolition", contract__price_rub=900_000.0, work_type="demolition"), "no", "conditional", "build"),
...
OBJECTION_CASES = [
    ...
    ("прямой договор, позиция СРО неизвестна", card(contract__procurement="direct"), "not_competitive", {}, "partially"),
