...
CASES = [
    ...
    ("капремонт 8 млн, торги", card(contract__price_rub=8_000_000.0, work_type="capital_repair"), "no", "yes", "build"),
    ...
    ("снос 900 тыс., торги", card(contract__kind="demolition", contract__price_rub=900_000.0, work_type="demolition"), "no", "yes", "build"),
