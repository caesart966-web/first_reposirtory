...
CASES = [
    ...
    ("добровольный тендер частного застройщика", card(contract__procurement="competitive", contract__procurement_law="voluntary_tender"), "yes", "no", "build"),
    ("капремонт МКД для регоператора, торги по ПП 615", card(customer__kind="regional_operator", work_type="capital_repair", contract__price_rub=30_000_000.0,
                                                          contract__procurement="competitive", contract__procurement_law="mandatory_tender"), "yes", "yes", "build"),
    ("контракт по 44-ФЗ", card(contract__procurement_law="44-fz"), "yes", "yes", "build"),
...
OBJECTION_CASES = [
    ...
    ("тендер застройщика, торги законом не предписаны", card(contract__procurement="competitive", contract__procurement_law="voluntary_tender"), "not_competitive", {}, "founded"),
    ("торги по 44-ФЗ, «мы не конкурентный»", card(contract__procurement_law="44-fz"), "not_competitive", {}, "unfounded"),
