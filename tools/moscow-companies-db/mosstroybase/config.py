...
# Чистая стройка (ОКВЭД-2), по решению заказчика — без проектирования
# и изысканий (71.11/71.12 можно вернуть опцией --okved):
#   41 — строительство зданий
#   42 — строительство инженерных сооружений
#   43 — работы строительные специализированные
# Сопоставление — по строковому префиксу кода ("41" накроет и 41.20).
DEFAULT_OKVED_PREFIXES = ("41", "42", "43")
