...
FIELD_SPECS: list[FieldSpec] = [
    ...
    FieldSpec("postal_address", "Почтовый адрес", "Адреса и связь", multiline=True,
              hint="Подставляется из юридического. Впишите свой, если адреса разные"),
    FieldSpec("phone", "Телефон", "Адреса и связь",
              hint="Необязательно: если есть — впишите. Например: +7 (812) 123-45-67"),
...
#: Основание полномочий в форме НЕ спрашивается: оно всегда одно и то же —
#: у юрлица Устав, у предпринимателя лист записи ЕГРИП. Само значение нужно
#: доверенностям («действующего на основании …»), поэтому программа
#: подставляет его молча. Значение из карточки, если оно там есть, важнее.
BASIS_DEFAULTS = {
    COMPANY: "Устав",
    ENTREPRENEUR: "Лист записи ЕГРИП",
}
