        ...
        <div className="mt-14 border-t border-white/10 pt-8">
          <div className="flex flex-col gap-8 lg:flex-row lg:justify-between lg:gap-12">
            ...
            {/* Ссылки на страницу с документами, а не кнопки всплывающего
                ...
                Одной строкой, а не столбиком: две ссылки под общей подписью
                читаются одной полкой, как реквизиты слева. Подпись «Правовая
                информация» — так эту полку называют на сайтах самих СРО, и
                посетитель узнаёт её без объяснений. */}
            <div className="lg:text-right">
              {/* Столбиком под одной подписью, а не в строку: строка из
                  подписи и двух ссылок шире 800px, рядом с реквизитами она
                  ломается на две и сталкивает ОГРН на новую строку уже на
                  1440px. Подпись «Правовая информация» — так эту полку
                  называют на сайтах самих СРО, посетитель узнаёт её без
                  объяснений. */}
              <BarLabel>Правовая информация</BarLabel>
