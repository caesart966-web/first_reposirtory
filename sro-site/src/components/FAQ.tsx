...
const ITEMS: { q: string; a: ReactNode }[] = [
  ...
  },
  {
    ...
    a: (
      <>
        Консультация ничего не стоит — ни первая, ни последующие. Платная только сама работа,
        и её цена зависит от вида СРО и объёма: что уже готово, а что придётся собирать. Точную
        сумму назову письменно до начала. Быстрее всего —{' '}
