...
const ITEMS: { q: string; a: ReactNode }[] = [
  ...
  },
  {
    ...
    a: (
      <>
        Нет: не менее двух специалистов, сведения о которых включены в национальный реестр,
        — обязательное требование к члену СРО, и работать они должны по основному месту
        работы. Но отсутствие специалистов сегодня не значит отказ: подходящий сотрудник
        может уже работать у вас, своего можно внести в реестр, а недостающего — нанять.
        Разобрал каждый путь в разделе{' '}
