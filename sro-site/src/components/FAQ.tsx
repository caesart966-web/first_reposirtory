...
const ITEMS: { q: string; a: ReactNode }[] = [
  ...
  },
  {
    ...
    a: (
      <>
        Зависит от вида СРО и готовности документов. Точную цифру назову письменно после
        короткого разбора вашей задачи — до начала работы. Быстрее всего —{' '}
        <a href="#quiz" className="font-medium text-accent-700 underline underline-offset-2">
          ответить на четыре вопроса в форме ниже
        </a>
        .
      </>
    ),
