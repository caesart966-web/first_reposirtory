...
const ITEMS = [
  ...
  {
    q: 'Сколько стоит?',
    a: 'Стоимость зависит от задачи: консультация, подготовка документов или сопровождение под ключ. Ориентиры — в разделе «Стоимость», точную сумму назову после уточнения деталей — письменно и до начала работы.',
  },
  {
