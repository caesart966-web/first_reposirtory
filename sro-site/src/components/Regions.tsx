  ...
  return (
    <Section id="regions" className="bg-neutral-50/55">
      <SectionHeading
        ...
        subtitle="Работаю дистанционно, личный визит не требуется. Для строительных компаний регион имеет значение: закон допускает вступление только в СРО своего субъекта РФ."
      />
