...
// предлагает секция «Виды СРО» ссылкой «Помогу определить», и тем же самым
// ответом на тот же вопрос. Один и тот же выбор в двух местах — не забота
// о посетителе, а лишний шум.
const SCENARIOS = [
  {
    tag: 'Срочно',
