  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10" aria-hidden="true">
        ...
        {/* Плёнка под текстом, три слоя: ровный по всему кадру; с 1024px
            добавочный слева, сходящий на нет к правому краю (текст там только
            в левой колонке); снизу — под вкладками. На телефоне и планшете
            текст идёт во всю ширину, поэтому там ровный слой плотнее.
            ...
            на небо. */}
        <div className="absolute inset-0 z-30 bg-[rgba(20,17,15,0.62)] lg:bg-[rgba(20,17,15,0.4)]" />
        <div className="absolute inset-0 z-30 hidden bg-[linear-gradient(90deg,rgba(20,17,15,0.8)_0%,rgba(20,17,15,0.6)_48%,rgba(20,17,15,0)_82%)] lg:block" />
