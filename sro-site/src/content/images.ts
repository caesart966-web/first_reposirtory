...
export const IMAGES = {
  ...
  // Первый экран. Тот же файл, что фон секции заявки (desk.*): кадр
  // заказчика, лицензия его. Повтор осознанный — сцена открывает страницу
  // в полную силу и закрывает её приглушённым фоном под квизом, как рамка;
  // в середине страницы этого кадра нет. Веса это не добавляет: файл один.
  hero: {
    src: './img/desk.webp',
