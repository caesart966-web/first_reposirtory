...
export type PageImage = {
  ...
  // Кран и план вертикальные, а первый экран на компьютере широкий — из них
  // видна горизонтальная полоса; у панорамы изыскателей, наоборот, на телефоне
  // видна узкая вертикальная часть. Какую именно — задаёт это поле.
  position?: string
}
