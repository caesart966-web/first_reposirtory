...
// СЕЙЧАС ТЕСТОВЫЙ ПЕРИОД: заявки идут заказчику работ, он проверяет доставку.
// После проверки боевой получатель — Игорь: 9001330219@mail.ru. Переключение
// и есть замена этой одной строки.
const MAIL_TO = 'abayhanov2000@gmail.com';
