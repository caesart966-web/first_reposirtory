...
ТЕЛЕФОНОВ НА САЙТЕ НЕТ — проверено по карточкам реестра 17.08.2026.
Карточка члена содержит ровно те же поля, что и выгрузка НОСТРОЙ:
наименование, рег.№, статус, дата регистрации, ОГРН, ИНН, КФ ВВ.
Единственный телефон на странице — самой ассоциации, в шапке и подвале.
Сверка двух карточек с nostroy.json совпала поле в поле.

Поэтому для поиска телефонов этот скрипт запускать бессмысленно.
Он остаётся на случай, если понадобится свежий срез состава СРО
(выгрузка НОСТРОЙ датирована 11.08.2026) или если ассоциация начнёт
публиковать контакты.

Запускать НА СВОЕЙ МАШИНЕ: в среде, где собирался этот репозиторий,
