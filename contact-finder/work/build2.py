...
for row in [
 ...
 ['Как отбирали','Сначала крупнейшие по взносу в КФ ВВ, далее сплошным проходом по алфавиту'],
 ['','' ],
 ...
 ['Оставшиеся члены СРО','Прогнать программой contact-finder с ключом Checko API на своём компьютере'],
 ['ИП в реестре (31 шт.)','Отложены на самый конец по указанию заказчика — ещё не пробивались'],
]:
    s.append(row)
