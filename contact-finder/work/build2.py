...
for row in [
 ...
 ['Самый быстрый путь ко всем 972','СРО «ПОС» (Ассоциация «Петровское объединение строителей»), +7 (812) 336-35-86, +7 (981) 871-91-72, office@sropos.ru. По ст. 7.1 ФЗ-315 реестр членов СРО обязан содержать номера контактных телефонов членов'],
]:
    s.append(row)
